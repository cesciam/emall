...
{
    public class ListaDeseoCrudFactory : CrudFactory
    {
        ListaDeseoMapper mapper;

        public ListaDeseoCrudFactory() : base()
        {

            mapper = new ListaDeseoMapper();
            dao = SqlDao.GetInstance();
        }

        public override void Create(BaseEntity entity)
        {
            var lista = (ListaDeseo)entity;
            var sqlOperation = mapper.GetCreateStatement(lista);
